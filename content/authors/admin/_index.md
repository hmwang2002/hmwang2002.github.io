...
organizations:
  - name: SAI, Shanghai Jiao Tong University

# Social network links
# Need to use another icon? Simply download the SVG icon to your `assets/media/icons/` folder.
profiles:
  - icon: at-symbol
    url: 'mailto:kiyotakawang@sjtu.edu.cn'
    label: E-mail Me
  # - icon: brands/x
...
Hi! My name is Haomin Wang（王昊旻）. Currently I'm a Ph.D. student in School of Artificial Intelligence at Shanghai Jiao Tong University, focusing on Multimodal Large Language Models and Computer Vision. Meanwhile, I'm also a research intern at Shanghai AI Laborotary. 
...
I'm currently looking for collaborations, feel free to contact me via email: kiyotakawang@sjtu.edu.cn.